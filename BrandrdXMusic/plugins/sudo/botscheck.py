...
@app.on_message(filters.command("infinitybots") & filters.group)
async def check_bots_command(client, message):
    ...
    processing_msg = await message.send_animation(
        animation="https://graph.org/file/e6b215db83839e8edf831.jpg",
